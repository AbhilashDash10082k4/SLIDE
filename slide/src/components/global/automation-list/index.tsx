...
import { useQueryAutomations } from "@/hooks/useQueryAutomations";
...
const AutomationList = (props: Props) => {
  ...
  //value passed in useMutationDataState is mutation data
    ...
    <div className="flex flex-col gap-y-3">
      ...
      >
        <div className="flex flex-col flex-1 items-start">
          ...
          {automation.keywords.length > 0 ? (/*Rendering the automation keywords */
          ...
          </div>) : (<div className="rounded-full border-2 mt-3 border-dashed border-white/60 px-3 py-1">
        ...
        <div className="flex flex-col justify-between">
          ...
          >
            Smart AI
          </GradientButton>): (<Button className="bg-background-80 hover:bg-background-80 text-white">Standard</Button>)}
        </div>
      </Link>))}
    </div>
  );
