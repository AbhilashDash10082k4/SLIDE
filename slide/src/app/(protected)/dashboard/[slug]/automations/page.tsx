      ...
      <div className="lg:col-span-2">
        <div className="flex flex-col rounded-xl bg-background-80 gap-y-6 p-5 border-[1px] overflow-hidden border-in-active">
          <div>
            ...
            <p className="text-text-secondary">All the live automations will show here</p>
          </div>
            ...
            {[1,2,3].map((item) => (
                ...
                className="flex items-start justify-between">
                    <div className="flex flex-col">
                        ...
                        <p className="text-text-secondary text-sm">December 21st 2024</p>
                    </div>
                    <Check/>
                </div>
            ))}
